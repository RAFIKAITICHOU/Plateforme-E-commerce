        ...
        <div class="col-md-8">
            <div class="profile-card d-flex">
                ...
                <div class="profile-avatar col-md-4">
                  @php
    $photo = $user->profile_photo_path && file_exists(public_path('storage/' . $user->profile_photo_path))
        ? asset('storage/' . $user->profile_photo_path)
        : asset('images/default-avatar.png');
@endphp

<img src="{{ $photo }}" alt="Photo de profil" class="img-fluid rounded-circle" style="width: 120px; height: 120px; object-fit: cover;">
